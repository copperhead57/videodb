NOTE: This Linux/Unix setup is UNTESTED. It is provided for contributors who
wish to develop or validate the Playwright environment on Linux. The project
owner does not have a Linux machine, so this guide may require adjustments.

Linux Portable Playwright Setup (videodb)
=========================================

A fully portable, deterministic Playwright + Chromium environment for Linux.
No global Node installation required. No PATH changes. No system dependencies
beyond standard Linux libraries.

Everything runs from:

    videodb/lib/playwright/linux/

This document explains how to:

- Verify the portable Playwright bundle
- Install portable Node.js correctly (Linux tar.xz version)
...
All commands in this guide are run from a **Bash shell**.

### 1. Open Terminal
Use your distro’s terminal application.

### 2. Navigate to the Playwright folder

    cd /path/to/videodb/lib/playwright/linux
...
Choose the Linux tar.xz:

    node-v25.x.x-linux-x64.tar.xz
    or
    node-v25.x.x-linux-arm64.tar.xz
...
------------------------------------------------------------
4. Expected Linux Playwright Folder Structure
------------------------------------------------------------
