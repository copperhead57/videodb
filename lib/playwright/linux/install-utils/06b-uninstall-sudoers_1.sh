...
# ------------------------------------------------------------
# PLAYROOT must be exported by the uninstall launcher
# ------------------------------------------------------------
if [[ -z "${PLAYROOT:-}" ]]; then
    echo "[FAIL] PLAYROOT not set. This script must be called from pw-uninstall.sh"
    exit 1
fi
...
# ------------------------------------------------------------
# Build Tier‑1 and Tier‑2 sudoers filenames
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Remove Tier‑2 sudoers (project-specific)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Reset wrapper + fetcher to raw Git state (664, pdb:pdb)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Check if any other Tier‑2 sudoers remain for this user
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Remove Tier‑1 only if no other Tier‑2 exist
# ------------------------------------------------------------
